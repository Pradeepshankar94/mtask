...
export default function Task1(){
    ...
    const handlesubmit = async(event) => {
        ...
        if(title === '' || title === null){
            ...
            await axios.post('http://localhost:3004/Task1_insert',datastring,config)
                  .then(function(res){
    ...
    useEffect(()=>{
        axios.get('http://localhost:3004/Task1_details_one')
        .then(function(res){
            setTitledetails(res.data);
        })
        axios.get('http://localhost:3004/Task1_details_two')
        .then(function(res){
            setTitledetails2(res.data);
        })
        axios.get('http://localhost:3004/Task1_details_three')
        .then(function(res){
    ...
    const movetwo = (id) => {
        axios.put('http://localhost:3004/Task1_m2/'+id)
             .then(function(res){
               if(res.data === 'updated'){
                   alert('Moved');
                   window.location.reload();
   ...
   const movethree = (id) => {
    axios.put('http://localhost:3004/Task1_m3/'+id)
         .then(function(res){
           if(res.data === 'updated'){
               alert('Moved');
               window.location.reload();
